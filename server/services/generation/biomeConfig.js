...
const BIOMES = [
  {
    ...
    tileset: "cave",
    enemyBaseCount: 15,
    enemyTypes: ["colorBat1", "colorBat2", "colorBat3", "colorBat4"],
    chestCount: [1, 3],
    generatorParams: { wallProbability: 0.35, minFloorRatio: 0.45 },
  },
  {
    id: "cave2",
    minDepth: 3,
    ...
    tileset: "cave",
    enemyBaseCount: 15,
    enemyTypes: ["colorBat3", "colorBat4", "colorBat7", "colorBat8"],
    chestCount: [1, 3],
    generatorParams: { wallProbability: 0.38, minFloorRatio: 0.42 },
  },
  {
    id: "forest1",
    minDepth: 6,
