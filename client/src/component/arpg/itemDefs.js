...
export const ITEM_DEFS = {
  ...
  ironAxe: {
    ...
    slot: "tool",
    name: "Hache en fer",
    description: "Outil de coupe robuste. Niveau 2.",
    toolType: "axe",
    toolTier: 2,
    stackable: false,
    price: 60,
  ...
  wood: {
    ...
    category: "craftingMaterial",
    name: "Bois",
    description: "Une bûche de bois brut, utilisée en artisanat.",
    stackable: true,
    price: 5,
  },
  berry: {
    ...
    category: "craftingMaterial",
    name: "Baies",
    description: "Des baies sauvages fraîchement cueillies.",
    stackable: true,
    price: 6,
  },
  resin: {
