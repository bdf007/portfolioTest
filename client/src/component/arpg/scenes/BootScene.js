...
export default class BootScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet(
      STANDARD_FIELDS1_AUTOTILE_SPRITESHEET.key,
      STANDARD_FIELDS1_AUTOTILE_SPRITESHEET.path,
      {
        frameWidth: STANDARD_FIELDS1_AUTOTILE_SPRITESHEET.frameWidth,
        frameHeight: STANDARD_FIELDS1_AUTOTILE_SPRITESHEET.frameHeight,
      },
    );
    this.load.spritesheet(
      STANDARD_FIELDS3_AUTOTILE_SPRITESHEET.key,
      STANDARD_FIELDS3_AUTOTILE_SPRITESHEET.path,
      {
        frameWidth: STANDARD_FIELDS3_AUTOTILE_SPRITESHEET.frameWidth,
        frameHeight: STANDARD_FIELDS3_AUTOTILE_SPRITESHEET.frameHeight,
      },
    );
    this.load.spritesheet(
